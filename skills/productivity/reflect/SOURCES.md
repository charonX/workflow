...
最终验收门 + 知识沉淀。工作流的价值一半在交付，一半在学习。本 skill 在 QA 全绿、bug 循环结束后做人最终验收确认，并提取经验教训，把个人直觉沉淀为项目级知识（`STANDARDS.md`、`engineering-lessons.md`），让下一个 story 的设计上下文更准确，同一错误不被重复支付。
...
- 简化为个人/OPC 经验沉淀。
- 新增最终验收门职责：QA 全绿、bug 循环结束后，人做最终验收确认。
- 与 REQ-ID 腐化指标、bug 循环发现率挂钩。
...
- 2026-07-10：承担最终验收门职责；取消 feel-signoff 相关指标；新增 bug 循环健康指标。
