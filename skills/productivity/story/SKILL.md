...
- 用户说"开始一个新功能"、"继续上次的 story"、"/story"时 → 路由分支。
...
| 当前 phase | 路由到 |
|---|---|
| THINK | `/demand-insight` |
| PRD | `/to-prd` |
| DESIGN | `/ux-explore`(若无设计系统,先 `/design-system`) |
| CRYSTALLIZE | `/crystallize` |
| TEST | `/test-author` |
| ASSERTION-SIGNOFF | `/assertion-signoff` |
| BUILD | `/implementer` |
| QA | `/qa-runner` |
| FEEL-SIGNOFF | `/feel-signoff` |
| REFLECT | `/reflect` |
...
| 情况 | 机制 | 动作 |
|---|---|---|
| REQ 漏了一个 case | feel-signoff 已有 | 回 `/crystallize` 补验收标准增量 |
